//! Control de congestión AIMD para Gravital Talk.
//!
...
use gravital_talk_core::constants::{CONGESTION_AIMD_INCREMENT, CONGESTION_MIN_BITRATE};
...
/// Controller de congestión para una sesión Gravital Talk.
#[derive(Debug)]
